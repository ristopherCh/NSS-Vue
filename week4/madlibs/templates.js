const templates = [
  {
    ...
    text: [
      ...
      ': 1) Piranhas are more ',
      ' during the day, so cross the river at night. 2) Avoid areas with netted ',
      ' traps--piranhas may be ',
      ' there looking to ',
      ' them! 3) When ',
      ' the river, swim ',
      ". You don't want to wake them up and make them ",
      '! 4) Whatever you do, if you have an open wound, try to find another way to get back to the ',
  ...
  },
  {
    ...
    text: [
      ...
      '  ran over to get in the long line that had about ',
      ' people in it. when I finally got on the roller coaster I was ',
      '. In fact, I was so nervous my two knees were knocking together. This was the ',
      ' ride I had ever been on! In about two minutes I heard the crank and grinding of the gears. Thats when the ride began! When I got to the bottom, I was a little ',
      ' but I was proud of myself. The rest of the day went ',
      '. It was a ',
      ' day at the fun park.'
    ],
    blanks: [
  ...
  },
  {
    ...
    text: [
      'A ',
      ' in ',
      ' was arrested this morning after he was caught ',
      ' in front of ',
      '. ',
      ' had a history of ',
      ', but no one-not even his ',
      "-ever imagined he'd ",
      ' with a ',
      ' stuck in his ',
      '. After drinking a ',
      ', cops followed him to a ',
      ' where he reportedly  ',
      'in the fry machine. Later, a woman from ',
      ' was charged with a similar crime. But rather than ',
      'with a ',
      ', she ',
      'with a ',
      ' dog. Either way, we imagine that after witnessing him ',
      ' with a ',
  ...
  },
  {
    ...
    text: [
      ...
      ' for ',
      ' blood. The sun can ',
      ' vampires, so they only ',
      ' at night and ',
      " during the day. Vampires also don't like ",
      ' so ',
      ' it or ',
      ' it around your ',
      ' to keep them away. If a vampire ',
      's a person and ',
      's their blood, they become a vampire, too. The only way to ',
      ' a vampire is with a ',
      ' through the ',
      ', but ',
  ...
  },
  {
    ...
    text: [
      ...
      ' and look kind of like old ',
      ". My friend Dana actually likes the meatloaf, even though it's ",
      ' and ',
      '. I call it "Mystery Meatloaf" and think it\'s really made out of ',
      ". My dad said he'd make my lunches, but the first day, he made me a sandwich out of ",
      " and peanut butter! I think I'd rather take my chances with the cafeteria!"
    ],
    blanks: [
      'adjective',
      'verb',
  ...
  },
  {
    ...
    text: [
      'Yesterday, my friend and I went to the park. On our way to the ',
      ' park, we saw big ',
      ' balloons tied to a ',
      '. Once we got to the ',
      ' park, the sky turned ',
      ...
      ' park again and hopefully it doesnt ',
      '!'
    ],
    blanks: [
      'adjective',
  ...
  },
  {
    ...
    text: [
      ...
      'says they saw a ',
      ' ',
      ' floating at the end of the hall near the cafeteria. Some say if you ',
      " down that hallway at night, you'll hear a ",
      ' growling deeply. My ',
      ' friend ',
      ' saw a ',
      ' ',
      ' slithering under the tables once. I hope I never see any ',
  ...
  },
  {
    title: 'Zombie Picnic',
    text: [
      'If zombies had a picnic, what would they ',
      ' to eat? Everybody knows zombies love to ',
      ' ',
      ', but did you know they also enjoy ',
      ' and even ',
      '? The best ',
      ' for a zombie picnic is when the moon is ',
      '. At least one zombie will bring ',
      " to drink, and it's not a picnic without ",
      ' with extra flesh on top. After eating, zombies will ',
      ' ',
      ' games like kick the ',
      ' and ',
      ' toss. What fun!'
  ...
  },
  {
    ...
    text: [
      ...
      ' live at the North pole. The weather is always ',
      ' there, but the ',
      ' ',
      ' toys for Santa to ',
      " to children on Christmas, so holiday cheer lasts year-round there. There's no land at the North Pole; instead there is a ",
      '-inch thick sheet of ',
      ' there, ',
      " enough to hold Santa's Village! The ",
      " help load Santa's sleigh with ",
      ", and Santa's ",
      ' ',
      ' his sleigh on Christmas Eve to ',
      ' ',
  ...
  },
  {
    title: 'Snowstorm!',
    text: [
      'Weather plays an important part in our ',
      's everyday. What is weather, you ask? Accoring to ',
      ' scientists, who are known as meteorologists, weather is what the ',
      ' is like at any given time of the ',
      ". It doesn't matter if the air is ",
      ' or ',
      ", it's all weather. When vapors in ",
      ' clouds condense, we have ',
      ' and snow. A lot of ',
      ' means a ',
      ' snowstorm!'
    ],
...
export const getByTitle = (title) => {
  return templates.find((t) => t.title === title)
}

export const getRandomTemplate = () => {
  const index = Math.floor(Math.random() * (templates.length + 1))
